...
These pages document version 0.4.4. Pin deployed dependencies, read the [changelog](https://github.com/Fareground/agents-sdk/blob/main/CHANGELOG.md), and run provider, tool and persistence acceptance checks before upgrading.
